...
#define GREEN_MOTION_DEFAULT_DEADZONE_PX (2)
...
#define GREEN_MOTION_Q2_FOLLOW_DEADZONE_PX (2)
#define GREEN_MOTION_Q2_FOLLOW_PX_PER_STEP (5)
#define GREEN_MOTION_Q2_FOLLOW_MAX_COMMAND_STEPS (8)
#define GREEN_MOTION_Q2_FOLLOW_FINE_ERROR_PX (30)
#define GREEN_MOTION_Q2_FOLLOW_FINE_MAX_COMMAND_STEPS (1)
#define GREEN_MOTION_Q2_FOLLOW_Y_FINE_ERROR_PX (30)
#define GREEN_MOTION_Q2_FOLLOW_Y_FINE_MAX_COMMAND_STEPS (1)
#define GREEN_MOTION_Q2_FOLLOW_X_GAIN_PERCENT (70)
#define GREEN_MOTION_Q2_FOLLOW_Y_GAIN_PERCENT (50)
